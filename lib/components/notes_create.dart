...
class NotesCreate extends StatelessWidget{
  ...
  NotesCreate({super.key, required this.titileControler, required this.descriptionControler, required this.onPressed});
              ...
              child: SizedBox(
                child: Row(
                  ...
                  children: [
                    ...
                    IconButton(onPressed: (){}, icon: const Icon(Icons.push_pin, color: Colors.white54,)),
